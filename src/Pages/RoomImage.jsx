...
function RoomImage() {
    ...
    async function handleSubmit(e){
        try{
            ...
            let data = await fetch("https://paradise-hotel-admin-panel-backend.vercel.app/uploadroomimage", {
                method: "POST",
                body: formData,
              })
              ...
              if(res.status === true || res.status){
                ...
                toast.success("Room Images has been Saved", {
                    position: "top-right",
                    autoClose: 1500,
                ...
                toast.error("Error Encountered while saving Room Images", {
                    position: "top-right",
                    autoClose: 3000,
