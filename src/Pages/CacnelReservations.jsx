...
import { CancelReservationCard } from '../Components/CancelReservationCard';
...
function CancelReservations() {
    ...
    let {getReservationData, get_token, admin_verify,searchReservation} = useAuth(); let [formData, setFormData] = useState({
        type : "cancel",
        query: "",
            ...
            try{
                ...
                if(!token || token === null){
                    ...
                    if(verify.admin_access === "pending"){
                        ...
                        let ReservationData = await getReservationData("cancel");
    ...
    <Header />
        {
            ...
            <div> {/*sub hotel body open*/}
                ...
                <div className='px-[2%] py-[5%] grid  grid-cols-1 gap-4'>    {
                        ...
                        data.map((val, i)=>{
                            return(
                                <CancelReservationCard data={val} key={i} />
                            )
