...
import { CloseReservationCard } from '../Components/CloseReservationCard';
            ...
            try{
                ...
                if(!token || token === null){
                    ...
                    if(verify.admin_access === "pending"){
                        ...
                        let ReservationData = await getReservationData("close");
...

    {
            ...
            <div> {/*sub hotel body open*/}
                ...
                <div className='px-[2%] py-[5%] grid  grid-cols-1 gap-4'>      
                {
                        ...
                        data.map((val, i)=>{
                            return(
                                <CloseReservationCard data={val} key={i} />
                            )
                        })
                        :
